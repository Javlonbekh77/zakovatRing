...
import { serverTimestamp, doc, runTransaction, updateDoc } from 'firebase/firestore';
...
export default function EditGamePage() {
    ...
    async function onSubmit(values: FormData) {
        ...
        if (!firestore || !user || !gameDocRef || !game) {
        ...
        try {
            const newRounds = values.rounds.map(r => {
                ...
                const originalRound = game.rounds.find(or => or.mainQuestion === r.mainQuestion);
                ...
                return {
                    ...
                    currentPoints: 1000, // Reset points on edit
                    // These are obsolete but kept for schema compatibility until migrated
